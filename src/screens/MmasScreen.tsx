...
const styles = StyleSheet.create({
  ...
  questionCard: { backgroundColor: '#F2EDE8', borderRadius: 14, padding: 16, marginBottom: 14 },
  ...
  yesNoBtn: { flex: 1, borderRadius: 10, borderWidth: 1, borderColor: '#E8E0D8', paddingVertical: 12, alignItems: 'center' },
  ...
  optionsCol: { gap: 8 },
  optionBtn: { borderRadius: 10, borderWidth: 1, borderColor: '#E8E0D8', paddingVertical: 12, paddingHorizontal: 14 },
  ...
  submitBtn: { backgroundColor: '#C96A50', borderRadius: 10, paddingVertical: 16, alignItems: 'center', marginBottom: 12 },
