...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#7A6A62', fontSize: 14, marginBottom: 20, lineHeight: 21 },
  input: { backgroundColor: '#F2EDE8', color: '#FAF7F4', borderRadius: 14, padding: 16, minHeight: 100, fontSize: 15, lineHeight: 22, textAlignVertical: 'top', marginBottom: 16 },
  button: { backgroundColor: '#C96A50', borderRadius: 10, paddingVertical: 16, alignItems: 'center', marginBottom: 24 },
  buttonDisabled: { opacity: 0.4 },
  buttonText: { color: '#FAF7F4', fontSize: 17, fontWeight: '800' },
  resultContainer: { gap: 8 },
  resultRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, backgroundColor: '#F2EDE8', borderRadius: 14, padding: 14 },
