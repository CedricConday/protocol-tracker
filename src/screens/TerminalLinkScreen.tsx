...
const styles = StyleSheet.create({
  ...
  cameraWrapper: { width: 260, height: 260, borderRadius: 14, overflow: 'hidden', position: 'relative', marginBottom: 32 },
  ...
  btn: { backgroundColor: '#C96A50', borderRadius: 10, paddingVertical: 14, paddingHorizontal: 40, marginTop: 8 },
  ...
  successIcon: { width: 72, height: 72, borderRadius: 36, backgroundColor: '#C96A5020', borderWidth: 2, borderColor: '#C96A50', alignItems: 'center', justifyContent: 'center', marginBottom: 20, minHeight: 72, minWidth: 72 },
