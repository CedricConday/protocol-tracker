      ...
      >
        ...
        {vitDDanger !== null ? (
          <View style={styles.vitDBanner}>
            <Text style={styles.vitDBannerText}>⚠ Vitamin D critically low ({vitDDanger} ng/mL). Contact Dr. Worms immediately.</Text>
          </View>
        ) : null}

        {showFatigueAlert ? (
          <View style={styles.fatigueBanner}>
            <Text style={styles.fatigueBannerText}>⚠ Fatigue pattern detected. Consider contacting Dr. Worms or resting today.</Text>
