...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#888888', fontSize: 13, lineHeight: 19, marginBottom: 20 },
  searchRow: { flexDirection: 'row', gap: 10, marginBottom: 20 },
  searchInput: { flex: 1, backgroundColor: '#1a1a1a', borderRadius: 10, padding: 12, color: '#ffffff', fontSize: 15, borderWidth: 1, borderColor: '#2a2a2a' },
  checkBtn: { backgroundColor: '#22c55e', borderRadius: 10, paddingHorizontal: 18, justifyContent: 'center' },
  checkBtnText: { color: '#0d0d0d', fontSize: 14, fontWeight: '700' },
  clearResult: { backgroundColor: '#0a2a0a', borderRadius: 10, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: '#22c55e44' },
  clearTitle: { color: '#22c55e', fontSize: 15, fontWeight: '700', marginBottom: 6 },
  clearSub: { color: '#888888', fontSize: 13, lineHeight: 18 },
  resultCard: { borderRadius: 10, marginBottom: 16, flexDirection: 'row', overflow: 'hidden' },
  severityBar: { width: 4 },
  ...
  drugName: { color: '#ffffff', fontSize: 16, fontWeight: '700', marginBottom: 4 },
  matchedAs: { color: '#888888', fontSize: 12, marginBottom: 6 },
  message: { color: '#cccccc', fontSize: 13, lineHeight: 19, marginBottom: 10 },
  altBox: { backgroundColor: '#ffffff11', borderRadius: 6, padding: 10 },
  altLabel: { color: '#22c55e', fontSize: 11, fontWeight: '700', textTransform: 'uppercase', marginBottom: 4 },
  altText: { color: '#cccccc', fontSize: 13, lineHeight: 18 },
  sectionTitle: { color: '#888888', fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 12, marginTop: 8 },
  ruleRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1a1a1a', borderRadius: 8, padding: 12, marginBottom: 8, gap: 10 },
  severityDot: { width: 8, height: 8, borderRadius: 4 },
  ruleContent: { flex: 1 },
  ruleName: { color: '#ffffff', fontSize: 14, fontWeight: '600' },
  ruleAliases: { color: '#555555', fontSize: 11, marginTop: 2 },
  ruleSeverity: { fontSize: 12, fontWeight: '700' },
  disclaimerBox: { backgroundColor: '#1a1a1a', borderRadius: 10, padding: 14, marginTop: 20 },
  disclaimerText: { color: '#555555', fontSize: 12, lineHeight: 18, textAlign: 'center' },
});
