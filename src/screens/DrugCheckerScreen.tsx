...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, backgroundColor: '#F2EDE8', borderRadius: 10, padding: 12, color: '#FAF7F4', fontSize: 15, borderWidth: 1, borderColor: '#E8E0D8' },
  checkBtn: { backgroundColor: '#C96A50', borderRadius: 10, paddingHorizontal: 18, justifyContent: 'center' },
  checkBtnText: { color: '#FAF7F4', fontSize: 14, fontWeight: '700' },
  clearResult: { backgroundColor: '#F0F7F0', borderRadius: 10, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: '#C96A5044' },
  ...
  ruleRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F2EDE8', borderRadius: 8, padding: 12, marginBottom: 8, gap: 10 },
  ...
  disclaimerBox: { backgroundColor: '#F2EDE8', borderRadius: 10, padding: 14, marginTop: 20 },
