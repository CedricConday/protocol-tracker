...
const styles = StyleSheet.create({
  ...
  contextText: { color: '#888888', fontSize: 12, textAlign: 'center' },
  quickRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 12 },
  quickChip: { backgroundColor: '#1a1a1a', borderRadius: 16, paddingHorizontal: 14, paddingVertical: 8, borderWidth: 1, borderColor: '#333333' },
  ...
  assistantBubble: { alignSelf: 'flex-start', backgroundColor: '#1a1a1a', borderWidth: 1, borderColor: '#2a2a2a' },
  bubbleText: { fontSize: 15, lineHeight: 20 },
  userText: { color: '#0d0d0d', fontWeight: '500' },
  assistantText: { color: '#ffffff' },
  saveBtn: { marginTop: 8, borderTopWidth: 1, borderTopColor: '#2a2a2a', paddingTop: 8 },
  saveBtnText: { color: '#22c55e', fontSize: 12, fontWeight: '600' },
  inputRow: { flexDirection: 'row', alignItems: 'center', padding: 16, borderTopWidth: 1, borderTopColor: '#1a1a1a', backgroundColor: '#0d0d0d' },
  input: { flex: 1, backgroundColor: '#1a1a1a', borderRadius: 20, paddingHorizontal: 16, paddingVertical: 10, color: '#ffffff', fontSize: 15, marginRight: 10 },
  sendBtn: { backgroundColor: '#22c55e', borderRadius: 20, paddingHorizontal: 16, paddingVertical: 10 },
  sendBtnDisabled: { opacity: 0.5 },
  sendBtnText: { color: '#0d0d0d', fontSize: 14, fontWeight: '700' },
  emptyText: { color: '#888888', textAlign: 'center', marginTop: 12, marginBottom: 24, fontSize: 15, lineHeight: 22 },
  settingsBtn: { backgroundColor: '#1a1a1a', borderWidth: 1, borderColor: '#22c55e', borderRadius: 10, paddingVertical: 12, paddingHorizontal: 24 },
  settingsBtnText: { color: '#22c55e', fontWeight: '700' },
});
